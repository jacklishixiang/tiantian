...
$(function()
{
	...
	$(window).scroll(function(){
		...
		if(a>=b-400)
		{
			...
			{
				$(".outside").animate({"left":"80px","opacity":"1"},1000);
				$(".outside p").animate({"left":"80px","opacity":"1"},1000);
				$(".outside span").animate({"left":"80px","opacity":"1"},1000);
				$(".home").animate({"right":"76px","opacity":"1"},1000);
				$(".home p").animate({"right":"76px","opacity":"1"},1000);
